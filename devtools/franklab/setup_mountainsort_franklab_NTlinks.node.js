...
fs.writeFileSync(output_directory_mountain+'/datasets.txt',datasets)
fs.writeFileSync(output_directory_mountain+'/pipelines.txt',pipelines);


//function make_symlink_tet(raw_fname_path, symlink_dir_path) {
//}
