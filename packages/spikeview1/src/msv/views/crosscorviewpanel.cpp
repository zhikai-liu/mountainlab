...
class CrosscorViewDataRenderer : public QThread {
public:
    void run();
...
public:
    ...
    CrosscorViewDataRenderer m_data_renderer;

    QPointF coord2pix(int m, int t, double val);
};

CrosscorViewPanel::CrosscorViewPanel()
{
    d = new CrosscorViewPanelPrivate;
    d->q = this;
...
void CrosscorViewPanel::setTemplate(const Mda32& X)
{
    d->m_template = X;
...
void CrosscorViewPanel::setElectrodeGeometry(const ElectrodeGeometry& geom)
{
    d->m_electrode_geometry = geom;
    d->m_data_render_needed=true;
}

void CrosscorViewPanel::setVerticalScaleFactor(double factor)
{
...
void CrosscorViewPanel::setChannelColors(const QList<QColor>& colors)
{
    d->m_channel_colors = colors;
    d->m_data_render_needed=true;
}

void CrosscorViewPanel::setColors(const QMap<QString, QColor>& colors)
{
    d->m_colors = colors;
    d->m_data_render_needed=true;
}

void CrosscorViewPanel::setCurrent(bool val)
{
    d->m_current = val;
}

void CrosscorViewPanel::setSelected(bool val)
{
    d->m_selected = val;
}

void CrosscorViewPanel::setTitle(const QString& txt)
{
    d->m_title = txt;
}

void CrosscorViewPanel::setFiringRateDiskDiameter(double val)
{
    d->m_firing_rate_disk_diameter = val;
}

void CrosscorViewPanel::paint(QPainter* painter)
{
    //qDebug() << "CrosscorViewPanel::paint" << "+++++++++++++++++++++++++++++";
...
void CrosscorViewDataRenderer::setup_electrode_boxes(double W, double H)
{
...
QPointF CrosscorViewDataRenderer::coord2pix(int m, int t, double val)
{
...
QPointF CrosscorViewPanelPrivate::coord2pix(int m, int t, double val)
{
...
void CrosscorViewDataRenderer::run()
{
