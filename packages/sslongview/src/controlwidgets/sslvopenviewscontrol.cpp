...
OpenViewsControl::OpenViewsControl(MVAbstractContext* context, MVMainWindow* mw)
    : MVAbstractControl(context, mw)
{
    d = new OpenViewsControlPrivate;
    d->q = this;
...
OpenViewsControl::~OpenViewsControl()
{
    delete d;
}

QString OpenViewsControl::title() const
{
    return "Open Views";
}

void OpenViewsControl::updateContext()
{
}

void OpenViewsControl::updateControls()
{
    d->m_close_all_button->setEnabled(!this->mainWindow()->allViews().isEmpty());
}

void OpenViewsControl::slot_open_view(QObject* obj)
{
...
void OpenViewsControl::slot_update_enabled()
{
...
void OpenViewsControl::slot_close_all_views()
{
