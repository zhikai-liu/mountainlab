...
ms_metrics_Processor::ms_metrics_Processor()
{
    ...
    this->setOptionalParameters("do_not_compute_pair_metrics");
...
bool ms_metrics_Processor::run(const QMap<QString, QVariant>& params)
{
    ...
    opts.do_not_compute_pair_metrics = params.value("do_not_compute_pair_metrics", false).toBool();
