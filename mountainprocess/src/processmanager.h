...
public:
    ...
    QString startProcess(const QString& processor_name, const QVariantMap& parameters, const RequestProcessResources& RPR, bool exec_mode); //returns the process id/handle (a random string)
    bool waitForFinished(const QString& process_id);
